  ...
  return (
    <div className='h-[500px] w-[300px] relative sm:mt-11'>
        <div className='h-[500px] w-[300px] overflow-hidden absolute z-10'>
            <motion.img variants={fadeIn('up', 0.2)} initial='hidden' whileInView='show' className='h-full w-auto object-cover rounded-[120px]' src="/images/about-me.jpg" alt=" about me image" />
        </div>
